...
exports.default = function (_ref) {
  ...
  api.get("/interviewers", function (req, res) {
    var mockResponse = [{
      id: "INTW5",
  ...
  api.get("/interviewer/:id/campaigns", function (req, res) {
    var mockStudyLine1 = [{
      id: "simpsons2020x00",
  ...
  api.put("/survey-unit/:id/state/:state", function (req, res) {
    var mockResponse = {
      hello: "hello"
    };
    res.status(200).json(mockResponse);
  ...
  api.put("/survey-unit/:id/viewed", function (req, res) {
    var mockResponse = {
      hello: "hello"
    };
    res.status(200).json(mockResponse);
  ...
  api.put("/survey-unit/:id/comment/:comment", function (req, res) {
    var mockResponse = {
      hello: "hello"
    };
    res.status(200).json(mockResponse);
  ...
  api.get("/campaign/:id/survey-units", function (req, res) {
    var unicityString = req.params.id;
    if (req.query.state) {
      unicityString += req.query.state;
    }
    var unicityCode = Math.abs(hashCode(unicityString));
    var mockResponse = [{
      id: "1023" + unicityCode,
      ssech: "hgSkR29",
      location: "95160",
    ...
    setTimeout(function () {
      res.json([].concat(mockResponse));
    }, 5000);
  });

  api.get("/survey-units/closable", function (req, res) {
    var mockResponse = [{
      id: "1023",
      ssech: "hgSkR29",
      location: "95160",
  ...
  api.get("/survey-unit/:id/states", function (req, res) {
    var mockResponse = {
      id: "ue432",
      states: [{
        id: 1,
  ...
  api.get("/campaign/:id/questionnaire-id", function (req, res) {
    var mockResponse = {
  ...
  api.get("/campaign/:id/survey-units/abandoned", function (req, res) {
    var mockResponse = {
      count: 0
    };
    res.json(mockResponse);
  ...
  api.get("/campaign/:id/survey-units/interviewer/:idep/closing-causes", function (req, res) {
    var date = new Date(req.query.date);
    var day = date.getDay();
    var month = date.getMonth();
    var mockResponse = void 0;
  ...
  api.get("/campaign/:id/survey-units/interviewer/:idep/contact-outcomes", function (req, res) {
    var date = new Date(req.query.date);
    var day = date.getDay();
    var month = date.getMonth();
  ...
  api.get("/campaign/:id/survey-units/contact-outcomes", function (req, res) {
    var date = new Date(Number(req.query.date));
    var day = date.getDay();
    var month = date.getMonth();
  ...
  api.get("/campaigns/survey-units/contact-outcomes", function (req, res) {
    var date = new Date(Number(req.query.date));
    var day = date.getDay();
    var month = date.getMonth();
  ...
  api.get("/campaigns/survey-units/state-count", function (req, res) {
    var date = new Date(Number(req.query.date));
    var day = date.getDay();
    var month = date.getMonth();
  ...
  // TODO state des clotures à ajouter (npaCount, npiCount et rowCount)
  api.get("/interviewers/survey-units/state-count", function (req, res) {
    var date = new Date(Number(req.query.date));
    var day = date.getDay();
    var month = date.getMonth();
  ...
  api.get("/campaign/:id/survey-units/not-attributed/state-count", function (req, res) {
    var date = new Date(Number(req.query.date));
    var day = date.getDay();
    var month = date.getMonth();
  ...
  api.get("/campaign/:id/survey-units/not-attributed/contact-outcomes", function (req, res) {
    var date = new Date(Number(req.query.date));
    var day = date.getDay();
    var month = date.getMonth();
